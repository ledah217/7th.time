...
- (void)setDouyuLiveListModel:(STDouyuLiveListModel *)douyuLiveListModel {
...
- (void)setHuoMaoLiveListModel:(STHuoMaoLiveListModel *)huoMaoliveListModel {
...
- (void)setPandaLiveListModel:(STPandaLiveListModel *)pandaLiveListModel {
...
- (void)setZhanqiLiveListModel:(STZhanqiLiveListModel *)zhanqiLiveListModel {
...
- (void)setQuanminLiveListModel:(STQuanMinLiveListModel *)quanminLiveListModel {
