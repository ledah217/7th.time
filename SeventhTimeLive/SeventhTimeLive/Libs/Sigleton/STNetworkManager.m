...
static STNetworkManager *_instance;
...
+(instancetype)sharedManager
{
    ...
    dispatch_once(&onceToken, ^{
        _instance = [[STNetworkManager alloc] init];
        //设置解析类型
...
- (void)getHomeRoomListWithCompletionHandler:(SuccessCallBack)callBack {
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STHomeRoomListModel class] json:roomListArr];
        callBack(roomList);
...
- (void)getHomeRoomWithLiveType:(NSString *)liveType andLiveId:(NSString *)liveId andCompletionHandler:(StreamCallBack)callBack {
    NSInteger currentTime = [self getCurrentTime];
    // http://api.maxjia.com:80/api/live/detail/?live_type=quanmin&live_id=29105&game_type=lol&lang=zh-cn&os_type=iOS&os_version=10.2&_time=1486399341&version=3.7.8&device_id=3949CAF7-D188-4F15-AD7E-6505C0725078&game_type=lol
...
- (void)getHuoMaoRoomListWithGameName:(NSString *)gameName andPageNum:(int)pageNum andCompletionHandler:(SuccessCallBack)callBack{
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STHuoMaoLiveListModel class] json:roomListArr];
        callBack(roomList);
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
...
- (void)getPandaRoomListWithGameName:(NSString *)gameName andPageNum:(int)pageNum andCompletionHandler:(SuccessCallBack)callBack {
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STPandaLiveListModel class] json:roomListArr];
        callBack(roomList);
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
...
- (void)getZhanQiRoomWithGameName:(NSString *)gameName andPageNum:(int)pageNum andCompletionHandler:(SuccessCallBack)callBack {
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STZhanqiLiveListModel class] json:roomListArr];
        callBack(roomList);
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
...
- (void)getQuanMinRoomWithGameName:(NSString *)gameName andCompletionHandler:(SuccessCallBack)callBack {
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STQuanMinLiveListModel class] json:roomListArr];
        callBack(roomList);
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
...
- (void)getDouyuRoomListWithGameName:(NSString *)gameName andOffset:(int)offset andCompletionHandler:(SuccessCallBack)callBack {
    ...
    [self GET:requestUrl parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSArray *roomListArr = responseObject[@"data"];
        NSArray *roomList = [NSArray yy_modelArrayWithClass:[STDouyuLiveListModel class] json:roomListArr];
        callBack(roomList);
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
